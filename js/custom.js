...
jQuery(document).ready(function() {
	...
	var subscribeEmail = $(".subscribe-email"),
		subscribeApiKey = $(".subscribe-apiKey"),
	...
	subscribeButton.on("click", function() {
		...
		// var dataString = 'email=' + subscribeEmail.val() + '&apiKey=' + subscribeApiKey.val() + '&message=' + subscribeMessage.val();

		// console.log(dataString);
		var data = {
			'email': subscribeEmail.val(),
				'apiKey': subscribeApiKey.val(),
					'message': subscribeMessage.val()
	};
	console.log(data);
		...
		$.ajax({
			...
			error: function(err) {
				console.log("CONNECT FORMLY ERR: ",err);
			}
		});
		return false;
	});
